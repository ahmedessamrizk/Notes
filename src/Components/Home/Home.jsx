...
export default function Home({ crrUser }) {
  ...
  let token = "test__" + localStorage.getItem("noteToken");
  ...
  const baseURL = "https://movie-db-notes-be.vercel.app/api/v1/note";
  ...
  async function getNotes() {
    let result = await axios.get(`${baseURL}/getUserNotes`, {
      headers: {
        authorization: token,
      },
    });
  ...
  function delNote() {
    ...
    if (noteDel._id != "") deleteFromAPI(noteDel._id);
  }
  //Delete all Notes
  function delAll() {
  ...
  function nextNote() {
    if (currIndex != Notes.length - 1) currIndex++;
    else currIndex = 0;
    openNote(currIndex);
  }
  function prevNote() {
    if (currIndex != 0) currIndex--;
    else currIndex = Notes.length - 1;
    openNote(currIndex);
  }
      ...
      {loadingScreen ? (
        ...
        <>
          <div className="addNote mt-5 d-flex justify-content-end">
            <button
              type="button"
              className="btn btn-primary text-white fw-bold btnMain"
            ...
            {!Notes ? (
              ...
              <button
                id="deleteAllBtn"
                className="btn btn-danger text-white fw-bold btnMain ms-3"
                data-bs-toggle="modal"
                data-bs-target="#deleteAllNotes"
              >
                Delete All
              </button>
            )}
                ...
                <div className="modal-content">
                  ...
                  <div className="modal-footer">
                    <button
                      typeof="button"
                      onClick={saveNote}
                      className="btn btn-primary text-white button-disabled"
                      id="addBtn"
                      data-bs-toggle="modal"
          ...
          <div className="notes">
            <div className="container">
                ...
                {Notes?.map((note, idx) => {
                  if (note.title != "" && note.desc != "") {
                    return (
                      <>
                        <div
                          className="col-lg-3 col-sm-6 position-relative"
                          key={idx}
                        >
                          <div
                            className="note text-center chosenColor rounded-3"
                            key={idx}
                            style={{
                              backgroundColor:
                                localStorage.getItem("note-color"),
                            }}
                          >
                            <div className="pin">
                            ...
                            <div className="dropdown d-flex justify-content-end me-3 pt-3">
                              ...
                              <ul className="dropdown-menu">
                                <div
                                  ...
                                  className="dropdown-item editSection d-flex justify-content-between px-3 fs-6 text-info"
                                >
                                ...
                                <div
                                  ...
                                  className="dropdown-item deleteSection d-flex justify-content-between px-3 fs-6 text-danger"
                                >
                            ...
                            <div
                              className="note-data py-3 pb-5"
                              data-bs-toggle="modal"
                              data-bs-target="#openNote"
                              onClick={() => {
                                openNote(idx);
                              }}
                            >
              ...
              {/* Open Note Modal */}
              <div
                className="modal fade openNoteModal text-center"
                id="openNote"
                tabIndex="-1"
                aria-labelledby="exampleModalLabel"
                aria-hidden="true"
              >
                <div className="modal-dialog modal-dialog-centered">
                  <div
                    className="modal-content chosenColor rounded-3"
                    style={{
                      backgroundColor: localStorage.getItem("note-color"),
                    }}
                  >
                    <div className="modal-header">
                      <button
                  ...
                  <div className="modal-content">
                    ...
                    <div className="modal-footer">
                      <button
                        ...
                        className="btn btn-primary text-white editBtn"
                        id="addBtn"
                        data-bs-dismiss="modal"
                        data-bs-toggle="modal"
                        data-bs-target="#checkedModal"
          ...
          <div
            className="open-box p-2 rounded-1 d-inline-block position-fixed"
            id="gear"
            onClick={showBox}
          >
